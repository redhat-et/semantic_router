...
def load_model_and_configs(model_path):
...
def main():
    ...
    try:
        model, tokenizer, task_configs, label_mappings = load_model_and_configs("./multitask_bert_model")
    ...
    print(f"\n✅ Python accuracy testing complete!")
