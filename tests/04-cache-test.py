...
class SemanticCacheTest(SemanticRouterTestBase):
    ...
    def test_cache_hit_with_identical_query(self):
        ...
        self.assertEqual(model1, model2, f"Routed to different models for identical queries: {model1} vs {model2}")
    ...
    def test_cache_hit_with_similar_query(self):
        ...
        self.print_request_info(
            payload=payload1,
            expectations="Expect: First request to be a cache miss"
        )
    ...
    def test_cache_metrics(self):
        ...
        self.print_response_info(
            response,
            {
                "Metrics Found": len(metrics_found),
                "Total Metrics": len(cache_metrics)
            }
        )
